...
def imgtest():
    ...
    model = YOLO('runs/detect/Luggage/weights/best.pt')
            ...
            for result in results:
                if result.boxes:
                    ...
                    if dd1 == 200:
                        ...
                        sendmail()
                        sendmsg("9487369530", "Prediction Name:" + object_name)
...
def sendmail():
    ...
    body = "Airport Luggage Detection"
...
def main_account_screen():
    ...
    main_screen.title("Airport Luggage  Detection ")

    Label(text=" Airport Luggage  Detection", width="300", height="5", font=("Calibri", 16)).pack()
